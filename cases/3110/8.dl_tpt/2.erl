[
    ...
    {cmds, 
        [
            ...
            "SENSe:<LTE|LTET><0|1|2>:CALL:CELL:BASic:SUBFrame:ASSignment:GENeral CF1", % 1(DSUUDDSUUD)
    ...
    {vs_power, [{range, {-60, -95}}, {step, 5}, {min_ratio, 0.8}, {min_speed, 50}]}, % {bler, 0.001}: BLER is mistaken as average BLER
    {vs_power, [{range, {-95, -60}}, {step, 5}, {min_speed, 50}]}
].
