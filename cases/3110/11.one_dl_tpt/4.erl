[
    ...
    {vs_power, [{range, {-45, -102}}, {step, 5}, {min_ratio, 0.8}, {min_speed, 33}]}, % {bler, 0.001}: BLER is mistaken as average BLER
    {vs_power, [{range, {-102, -45}}, {step, 5}, {min_ratio, 0.8}, {min_speed, 33}]}
].
